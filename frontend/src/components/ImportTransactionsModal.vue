              ...
              <div>
                ...
                <div v-if="isCustomMapping" style="border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 1.5rem; margin-top: 1rem; background-color: var(--bg-primary);">
                  ...
                  <div v-if="currentStep === 1">
                    <h4 style="font-size: 0.95rem; margin-bottom: 1rem; font-weight: 600;">Step 1: Identify Delimiters & Transaction Type Column</h4>
                    ...
                    <div v-if="operationTypeColumnIdx !== null && uniqueOperationTypes.length > 0" style="margin-top: 1.5rem; max-width: 600px;">
