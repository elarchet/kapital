...
- **Size Budget**: No file (Vue component, Python module, etc.) should exceed ~400 lines. If a file approaches this limit, refactor it by extracting sub-components or splitting logic into dedicated modules.
